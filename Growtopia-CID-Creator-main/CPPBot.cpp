...
int portya;
char nicknya,passwordkah,gmailges;


cout << "Masukan Port: " << endl;
cin >> portya;
cout << "Masukan ID Nya: " << endl;
cin >> nicknya;
cout << "Masukan Passwordnya: " << endl;
cin >> passwordkah;
cout << "Masukan Email nya (Hanya Email tanpa @gmail.com): " << endl;
cin >> gmailges;
...
void botSetup() {
	...
	bot1 = makeBot(user1, pass1,"213.179.209.168", portya, vers, wn);
	while (true) {
		bot1.eventLoop();
	}
}
